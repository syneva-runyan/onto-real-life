...
export default function newZealandTravelThoughts() {
  return (
	<div>
<ol>
    <li>
        <strong>Q. What is the 48 hour rule?</strong><br />
        <p className="quote">Every 48 hours, somebody is going to mention Donald Trump.</p>
    ...
    <br />
    <li>
        <strong>Q. Why am I traveling alone?</strong><br />
        <p>I've been asked this question so many times.  Do guys traveling alone get asked this as much?<br />
        The short answer to this question is that it's easier to travel alone.  A lot of my friends are either still in school, don't have the financial resources, or simply have other priorities or commitments.</p>
        <p>The long answer is even though I've thought about doing longer term travel for awhile, I bought my ticket without much notice and without taking the time to find anyone to travel with.</p>
        <p>I woke up on a Saturday crying for no specific reason.  I was just that unhappy with various things in my life.  Since I really dislike sitting around and moping, I got up, bought a six month round trip ticket to NZ and Australia, then went on a 10k run.  Killed the run, and felt infinately better.</p> 
    </li>
     <li>
        <strong>Q. How's cooking going?</strong><br />
        <p>I'm terrible at cooking.  Like, I've started kitchen fires, and I burn nachos level of terrible.</p>
        <p>Eating out in New Zealand is so freaking expensive though, and frankly, I didn't think it was possible, but I'm tired of eating fries.  They don't even taste good anymore, but I still keep on ordering them. So. Many. Burgers. And. Fries.</p>
        ...
        <p className="quote">Cooking is still a work in progress, but I did manage to make some spaghetti for dinner earlier this week.</p>
        <p>Pathetically, yes I'm proud of that.  Baby steps.  Will report back on progress later.</p>
    </li>
    <li>
        <strong>Q. Am I making friends?</strong><br />
        Yes Mom, stop worrying.<br /><br />
        <figure className="align-left width--50 margin--right">
            <img src="../assets/img/blogs/nzTravelThoughts/lion.jpg" className="lazyload blur-up"/>
            <figcaption className="caption">There are people on the streets everywhere walking around with Lion stuffed animals.</figcaption>
        </figure>
       ...
       <p> Not everyone wants to be friendly.  There was an American girl my age in Napier I met on the 4th of July who had also quit her job, was traveling alone for several months, and was also going to Indonesia in a few weeks.  She wasn't particularly intereted in talking, so I didn't push it.
    ...
    <br />
     <li>
        ...
        <figure className="align-left width--30 margin--right sm-width--100">
            <img src="../assets/img/blogs/nzTravelThoughts/roundabout.jpg" className="lazyload blur-up"/>
            <figcaption className="caption"><em>Swindon, England.</em>  The Mecca of all roundabouts.</figcaption>
        </figure>
