...
<p>Everything is spread out, and there's the added inconvenience of mountains everywhere.</p>
<figure>
    <img
    ...
    />
    <figcaption class="caption">One can not simply drive over the Southern Alps.</figcaption>
</figure>
<p>Partly due of this distance between things, and partly due to the sheer amount of things to do, the three weeks I spent on the south island were not enough.  <strong>six weeks</strong> would have been more appropriate.</p>
<figure class="align-left width--50 sm-width--100 margin--right">   
    <img
        ...
        class="lazyload blur-up"
    />
    <figcaption class="caption">Hiking in snow was new to me.</figcaption>
</figure>
...
<figure class="align-right width--50 sm-width--100 margin--left">   
    <img
        ...
        class="lazyload blur-up"
    />
    <figcaption class="caption">There was a line to take this picture, mostly full of 'mericans.</figcaption>
</figure>
<p>Am I too young to retire?</p>
<p>I could happily live out the end of my days admiring the mountains surrounding the serene lake front and taking short (or long) day hikes every morning in Wanaka.</p>
<p>The hike to Roy's Peak here is <a target="blank" href="https://www.instagram.com/explore/locations/348092887/roys-peak/">instagram-famous.</a>  When I read the DOC's (Department of Conservation's) description of the track as "demanding," with a time estimate of 5-6 hours, I scoffed.  <em>Psh... </em> The estimates are always overdone, and from the car park at the peak's base, the "mount" looks more like a large hill.</p>
<p>Holy crap I was wrong.</p>
<p>There are no downhill breaks, no meandering flat sections on the hike up. No exaggeration, the hiking trail goes uphill for <em>two and a half hours</em> straight.</p>
<p>A lot of people make it the two hours up to the picture viewpoint then turn around.  Doing the extra 30 minutes up to the peak is well worth the effort though.</p>
<p class="quote">I claim bragging rights for making it all the way up.</p>
<figure>   
    <img
        alt="Mt Roy's Peak"
        data-sizes="auto"
...
<p>Naturally, as soon as I realized peanut butter factories existed and that there was one in Nelson that gave tours, I had to go.  This wasn't an option, or a <em>"if I have time,"</em> or <em>"if I feel like it"</em> thing.  <strong>Had. To. Go.</strong></p>
<p>The tour included peanut butter tasting, a make-your-own-peanut-butter segment, and a brief history of the <a target="blank" href="https://www.picspeanutbutter.com/go-to-stories/stories/nice-to-see-you-lovely-peanut-butter-lover/">founder</a>, who used to own laundry mats, then started going blind at 55 (from mascular degeneration) and needed a new profession.</p>
<p>While I do love peanut butter and 100% loved the tour, I didn't pick Pic's for my top list for being amazing in itself.  It's representative of a number of small, passionate, community focused businesses I came across on the South island.</p>
...
<p>Since I'm trying not to go broke, I wasn't able to go paragliding and jet boating and canyon swinging, AND skydiving... but I did at least go Bungy jumping in Queenstown.</p>
...
<figure class="width--30 sm-width--100 align-left margin--right">   
    <img
        ...
        class="lazyload blur-up"
    />
    <figcaption class="caption">Average weight of a Southern Albatross is 18.7lbs with a wingspan of ~9.8 ft. <a href="https://en.wikipedia.org/wiki/Southern_royal_albatross" target="blank"><em>src: wikipedia</em></a></figcaption>
</figure>
...
<p><em>"Ice Explorer"</em> set false expectations for the tour I did on Franz Joseph glacier, since the group moved at a pace of ~less than 0.5mph.  Nevertheless, getting to fly on a helicopter, wearing crampons for the first time, and shuffling through ice tunnel was something I won't forget.</p>
<p class="quote">Because of the recession of the Franz Joseph and Fox glaciers in the past few years (<em>thanks Donald Trump and global warming</em>), the only way to access the glaciers is via helicopter.</p>
<p>Helicopter flights are expensive, which makes glacier tours expensive. Ontop of the expense, the weather around Franz Joseph and the Fox Glaciers are so variable, that there's a good chance on any given day that helicopters won't be able to land, either canceling your trip, or stranding you on the glacier overnight.</p>
<figure>
    <img
        alt=""
        data-sizes="auto"
...
<p>I wasn't stranded, but my first trip was canceled.  Our group made it as far as zipping up our tour jackets before they canceled.  I was lucky enough to reschedule for 8am the next morning, but a lot of people weren't hanging around and had to be refunded.</p>
<h3>6. Q: What is the only type of beef the Queen of England will eat?</h3>
<p><em>A: Highlander Beef</em></p>
<figure class="align-left margin--right width--50">
    <img
        ...
        class="lazyload blur-up"
    />
    <figcaption class="caption">Despite contradiction from numerous non-kiwis, nobody seemed to call these Wellies. They're gumboots as far as I can tell.</figcaption>
</figure>
...
<hr></hr>
<p>I've loved visiting both the North and South Islands in New Zealand, but of the two, the South's unique culture and unreal beauty epitomized in my top 8 picks was the one that captured my heart.  The only thing I really disliked on the South island was the lack of big cities <em>(and cheaper pints)</em>.  Size is relative though, and I hear the country is recruiting developers.  Maybe I'll be back again with more time to do everything I've yet to do.  Maybe on that trip I'll even bring better <em>(and more)</em> music.
<h3>Other Highlights</h3>
<ul>
    <li><strong>Lake Matheson: </strong> 
    Pictures don't do this place justice.  Go at sunrise for the best views.  Keep in mind that once you park it's still a 20 minute walk to the main viewpoint. Don't do what I did, wake up early and aim to get to the carpark at sunrise...</li>
    <figure>
        <img
        alt=""
        data-sizes="auto"
    ...
    <li><strong>Abel Tasman Kayak Tour: </strong> Seal pups are just like puppies - curious and playful.  One literally swam to the bow of my double kayak to say hi.
        <figure>
            <img
                alt=""
                data-sizes="auto"
    ...
    <li><strong>Milford Sound: </strong> A lot of people I talked to called Milford Sound the highlight of their trip. The fjord was magnificent and the waterfalls majestic.
      If I come back to the South Island, I plan on doing overnight hiking in this area.
     <figure>
        <img
        alt=""
        data-sizes="auto"
    ...
    <li>
        <strong>Dunedin Street Art: </strong> The isite gives out maps for a great street art crawl around the city center.
        <figure>
            <img
            alt=""
            data-sizes="auto"
    ...
    <li>
        <strong>Queenstown Winterfest: </strong> Smaller-scaled than I expected, but had some good laughs at the dog barking competition and several fun nights out. Queenstown is a tiny city, but somehow they've managed to fit 42 bars inside the city limits.  That says something right there about what to expect from Queenstown.
     <figure>
            <img
            alt=""
            data-sizes="auto"
            ...
            class="lazyload blur-up"
        />
        <figcaption class="caption">Look at those smiles in the crowd.  How can you not love a dog barking contest.</figcaption>
        </figure>
    </li>
