  ...
  render() {
    return (
      <div className='aboutMe'>
        ...
        <p>There was always a time card I fogot to fill in, or an email I composed in my head over vacation, making it perfect to send when I was back.  A month into my trip, I still find myself wondering about how my work team is getting along, but long term travel is giving me permission to forget about that team and all my time cards and focus on me.</p>
